...
CREATE DATABASE IF NOT EXISTS `silub` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `silub`;
...
(
    ...
    `estado_cliente`     varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL DEFAULT 'ACTIVO',
...
(
    ...
    CONSTRAINT `fk_equipo_estante1` FOREIGN KEY (`id_estante`) REFERENCES `estante` (`id_estante`),
    CONSTRAINT `fk_equipo_nombre_equipo1` FOREIGN KEY (`id_tipo_equipo`) REFERENCES `tipo_equipo` (`id_tipo_equipo`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 78
...
(
    ...
    CONSTRAINT `fk_kardex_nombre_equipo1` FOREIGN KEY (`id_tipo_equipo`) REFERENCES `tipo_equipo` (`id_tipo_equipo`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 41
  DEFAULT CHARSET = utf8
  COLLATE = utf8_unicode_ci;
...
(
    ...
    `nombre`             varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `estado_laboratorio` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'ACTIVO',
...
(
    ...
    `estado_prestamo`         varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'ACTIVO',
    ...
    CONSTRAINT `fk_prestamo_cliente1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`),
    CONSTRAINT `fk_prestamo_equipo1` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id_equipo`),
    CONSTRAINT `fk_prestamo_solicitud_adecuacion1` FOREIGN KEY (`id_solicitud_adecuacion`) REFERENCES `solicitud_adecuacion` (`id_solicitud_adecuacion`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 11
  DEFAULT CHARSET = utf8
  COLLATE = utf8_unicode_ci;
...
(
    ...
    CONSTRAINT `fk_sancion_cliente1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 12
  DEFAULT CHARSET = utf8
  COLLATE = utf8_unicode_ci;
...
(
    ...
    `puestos_trabajo`             varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `estado_solicitud_adecuacion` varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'ACTIVO',
    ...
    CONSTRAINT `fk_solicitud_adecuacion_laboratorio1` FOREIGN KEY (`id_laboratorio`) REFERENCES `laboratorio` (`id_laboratorio`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 15
  DEFAULT CHARSET = utf8
  COLLATE = utf8_unicode_ci;
...
(
    ...
    `cantidad`                varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
(
    ...
    `estado`             varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL DEFAULT 'ACTIVO',
    `correo_electronico` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
    `nombre_persona`     varchar(45) CHARACTER SET utf8 COLLATE utf8_unicode_ci  NOT NULL,
...
DELIMITER //
CREATE PROCEDURE `dar_baja_equipo`(IN `_id_equipo` INT,
                                   IN `_id_tipo` INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `delete_equipo`(IN `_id_equipo` INT,
                                 IN `_id_tipo` INT)
BEGIN
    DECLARE v_tipo VARCHAR(50);
    SELECT tipo INTO v_tipo FROM tipo_equipo WHERE id_tipo_equipo = _id_tipo;
...
DELIMITER //
CREATE PROCEDURE `delete_operacion`(IN `_id_equipo` INT,
...
BEGIN
    ...
    ELSE
        SELECT e.*,
               ...
               t.total,
               s.*,
               s.nombre as nombre_estante,
               a.*,
               a.nombre as nombre_armario,
               b.*,
...
DELIMITER //
CREATE PROCEDURE `insert_armario`(IN `_id_bodega` INT,
...
DELIMITER //
CREATE PROCEDURE `insert_equipo`(IN `_descripcion` VARCHAR(50),
                                 IN `_tipo` VARCHAR(50))
BEGIN
    DECLARE v_tipo VARCHAR(50);
    ...
    INSERT INTO equipo
    set id_tipo_equipo = v_id_tipo_equipo,
...
DELIMITER //
CREATE PROCEDURE `insert_estante`(IN `_id_armario` INT,
                                  IN `_nombre` VARCHAR(50))
BEGIN
...
DELIMITER //
CREATE PROCEDURE `insert_kardex`(IN `_id_tipo_equipo` VARCHAR(50),
                                 IN `_tipo` VARCHAR(50),
...
DELIMITER //
CREATE PROCEDURE `insert_operacion`(IN `_id_equipo` INT,
...
DELIMITER //
CREATE PROCEDURE `insert_solicitud_adecuacion`(IN `_id_laboratorio` INT,
                                               IN `_id_cliente` INT,
...
BEGIN
    ...
    INSERT INTO solicitud_adecuacion
    SET id_laboratorio    = _id_laboratorio,
...
DELIMITER //
CREATE PROCEDURE `insert_varios_equipos`(IN `_cantidad` VARCHAR(50),
                                         IN `_descripcion` VARCHAR(50),
                                         IN `_tipo` VARCHAR(50))
BEGIN
...
DELIMITER //
CREATE PROCEDURE `prestar_equipo`(IN `_id_cliente` INT,
                                  IN `_id_equipo` INT,
...
DELIMITER //
CREATE PROCEDURE `sancionar_cliente`(IN `_id_cliente` INT
    ,
                                     IN `_fecha_fin` DATE)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `terminar_prestamo`(IN `_id_equipo` INT
    ,
                                     IN `_id_prestamo` INT)
BEGIN
    UPDATE equipo
...
DELIMITER //
CREATE PROCEDURE `update_equipo`(IN `_id_equipo` INT,
...
DELIMITER //
CREATE PROCEDURE `update_equipo_solicitud`(IN `_id_tipo_equipo` INT,
                                           IN `_id_solicitud_adecuacion` INT,
                                           IN `_cantidad` VARCHAR(50))
BEGIN
    IF _cantidad <= '0' THEN
        DELETE
        FROM solicitud_adecuacion_equipo
        WHERE id_tipo_equipo = _id_tipo_equipo
          AND id_solicitud_adecuacion = _id_solicitud_adecuacion;
    ELSE
        IF IF((select count(*)
               from solicitud_adecuacion_equipo s
               where s.id_solicitud_adecuacion = _id_solicitud_adecuacion
                 and s.id_tipo_equipo = _id_tipo_equipo) = 0, 1, 0) THEN
            INSERT INTO solicitud_adecuacion_equipo
            SET id_tipo_equipo          = _id_tipo_equipo,
                id_solicitud_adecuacion = _id_solicitud_adecuacion,
                cantidad                = _cantidad;
        ELSE
            UPDATE solicitud_adecuacion_equipo
...
DELIMITER //
CREATE PROCEDURE `_login`(IN `_usuario` VARCHAR(50),
...
DELIMITER //
CREATE EVENT `revisar_sanciones_clientes` ON SCHEDULE EVERY 1 DAY STARTS '2018-10-31 08:24:45' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Revisa si la sanción del cliente ya se a cumplido y cambia el es' DO
    BEGIN
...
DELIMITER //
CREATE TRIGGER `sancion_after_delete`
    AFTER DELETE
    ON `sancion`
    FOR EACH ROW
BEGIN
